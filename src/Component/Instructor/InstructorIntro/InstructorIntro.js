...
import img1 from "./images/instea.jpg";
import { useNavigate } from 'react-router-dom';
import img2 from "./images/rewins.jpg"
import img3 from "./images/rewin2.jpg"
import img4 from "./images/rewin3.jpg"
import img5 from "./images/instea1.jpg"
import img6 from "./images/instea2.jpg"
import img7 from "./images/instea3.jpg"
    ...
    <>
      <div className='flex flex-col lg:flex-row justify-center items-start bg-slate-100 lg:mb-20'>
        <div className='flex flex-col justify-center items-center lg:w-[26%] mt-8 lg:mt-20'>
          ...
          <p className='text-xl w-[80%] lg:w-auto mt-3  lg:ml-[0%] text-center lg:text-left'>
          ...
          <button
            ...
            onClick={() => navigate("/home/instructor-apply")}
